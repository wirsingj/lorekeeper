...
writeFileSync(
  ...
  [
    ...
    "3. Paste the invite link from the host into the Join A Table panel.",
    ...
    "3. Click Invite on an existing party member, or Invite / Copy Seat Link for a new character.",
